...
CATEGORY_KEYWORDS = {
    "defense": {
        ...
        "missile", "military base", "alliance", "deterrence", "article 9", "threat", "north korea", "china", "russia", 
    },
    "economy": {
    ...
    "nuclear": {
        ...
        "power plant", "nuclear weapons", "world free of nuclear weapons", "atomic bomb survivors"
    },
    "immigration": {
